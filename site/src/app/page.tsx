					...
					<div className="flex flex-col gap-3">
						...
						<table className="w-full text-xs">
							...
							<tbody className="opacity-70">
								...
								<tr className="border-t border-white/10 hover:bg-white/5 transition-colors"><td className="py-2 pr-6 font-mono">pauseOffscreen</td><td className="py-2 pr-6">true</td><td className="py-2">Pause the animation when the element scrolls out of view; resume when visible. Uses IntersectionObserver internally.</td></tr>
								<tr className="border-t border-white/10 hover:bg-white/5 transition-colors"><td className="py-2 pr-6 font-mono">as</td><td className="py-2 pr-6">&apos;p&apos;</td><td className="py-2">HTML element to render, e.g. &apos;h1&apos;, &apos;span&apos;. Accepts any valid React element type. (FloodText component only)</td></tr>
							</tbody>
						</table>
					</div>
				</div>
