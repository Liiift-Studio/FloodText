					...
					<div className="flex flex-col gap-3">
						...
						<table className="w-full text-xs">
							...
							<tbody className="text-muted">
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">effect</td><td className="py-2 pr-6">&apos;wght&apos;</td><td className="py-2">&apos;wght&apos; | &apos;wdth&apos; | &apos;oblique&apos; | &apos;opacity&apos; | &apos;rotation&apos; | &apos;blur&apos; | &apos;size&apos;. Pass an array to layer multiple effects simultaneously. Note: oblique requires Chrome 87+, Firefox 88+, Safari 14.1+. size causes layout recalculation per frame — use low amplitude.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">source</td><td className="py-2 pr-6">&apos;fixed&apos;</td><td className="py-2">&apos;fixed&apos; — all characters share the same amplitude. &apos;sentiment&apos; — per-word AFINN emotional valence scores scale the amplitude; requires <code className="font-mono">npm install sentiment</code>, falls back to &apos;fixed&apos; if not installed.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">amplitude</td><td className="py-2 pr-6">auto</td><td className="py-2">Peak deviation from neutral. Used for single-effect mode. Defaults: wght 200, wdth 20, oblique 15deg, opacity 0.3, rotation 15deg, blur 2px, size 0.15em.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">amplitudes</td><td className="py-2 pr-6">—</td><td className="py-2">Per-effect amplitude overrides when layering multiple effects. E.g. <span className="font-mono">{`{ wght: 300, blur: 3 }`}</span>.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">properties</td><td className="py-2 pr-6">—</td><td className="py-2">Animate any CSS property or CSS custom property on each character, driven by the same wave. Each entry: <span className="font-mono">{`{ property, base, amplitude, unit?, clamp? }`}</span>. Works with CSS variables. E.g. <span className="font-mono">{`[{ property: 'letter-spacing', base: 0, amplitude: 0.05, unit: 'em' }]`}</span> or <span className="font-mono">{`[{ property: '--my-axis', base: 100, amplitude: 20 }]`}</span>.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">period</td><td className="py-2 pr-6">4</td><td className="py-2">Seconds per full wave cycle.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">density</td><td className="py-2 pr-6">2</td><td className="py-2">Wave cycles visible across the paragraph at once. Higher = more bands.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">direction</td><td className="py-2 pr-6">&apos;diagonal-down&apos;</td><td className="py-2">&apos;diagonal-down&apos; ↘ | &apos;diagonal-up&apos; ↗ | &apos;right&apos; → | &apos;left&apos; ←. Diagonal directions use 2D character positions.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">waveShape</td><td className="py-2 pr-6">&apos;sine&apos;</td><td className="py-2">&apos;sine&apos; | &apos;sawtooth&apos; | &apos;triangle&apos;</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">pauseOffscreen</td><td className="py-2 pr-6">true</td><td className="py-2">Pause the animation when the element scrolls out of view; resume when visible. Uses IntersectionObserver internally.</td></tr>
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">as</td><td className="py-2 pr-6">&apos;p&apos;</td><td className="py-2">HTML element to render, e.g. &apos;h1&apos;, &apos;span&apos;. Accepts any valid React element type. (FloodText component only)</td></tr>
							</tbody>
						</table>
					</div>
				</div>
